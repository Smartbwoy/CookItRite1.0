...
class CreateMealActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var newMeal:Recipe= Recipe("Ise")
        recipeName.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                newMeal.mealName= p0.toString()
            }
        })
        ingredient_Text.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                newMeal.ingredients= p0.toString()
            }
        })
        method_Text.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                newMeal.method= p0.toString()
            }
        })

        save_button.setOnClickListener{
            val jsonPerson: String = gson.toJson(newMeal)
            println(jsonPerson)
        }
